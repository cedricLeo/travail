...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Modes_paiementRepository")
...
class Modes_paiements{
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Hebergements $hebergementPaiement
     */
    public function addHebergements(\MyApp\GlobalBundle\Entity\Hebergements $hebergementPaiement)
    {
