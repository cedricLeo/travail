...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Attraits_categoriesRepository")
...
class Attraits_categories{
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Attraits_sous_categories $sousCategorieAttraitId
     */
    public function addAttraits_sous_categories(\MyApp\GlobalBundle\Entity\Attraits_sous_categories $sousCategorieAttraitId)
    {
     ...
     * Add attrait
     *
     * @param MyApp\GlobalBundle\Entity\Attraits $attrait
     */
    public function addAttraits(\MyApp\GlobalBundle\Entity\Attraits $attrait)
    {
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Texte_province_attrait $texteProvinceAttrait
     */
    public function addTexte_province_attrait(\MyApp\GlobalBundle\Entity\Texte_province_attrait $texteProvinceAttrait)
    {
