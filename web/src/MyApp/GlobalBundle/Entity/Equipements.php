...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\EquipementsRepository")
...
class Equipements
{
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Hebergements $hebergementEquipement
     */
    public function addHebergements(\MyApp\GlobalBundle\Entity\Hebergements $hebergementEquipement)
    {
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Chambres $chambreEquipement
     */
    public function addChambres(\MyApp\GlobalBundle\Entity\Chambres $chambreEquipement)
    {
