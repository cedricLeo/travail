...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_province_santeRepository")
...
class Texte_province_sante {
     ...
     * Set sante
     *
     * @param MyApp\GlobalBundle\Entity\Types_soins_sante $sante
     */
    public function setSante(\MyApp\GlobalBundle\Entity\Types_soins_sante $sante)
    {
        $this->sante = $sante;
    }
