...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_province_restaurantRepository")
...
class Texte_province_restaurant {
     ...
     * Set cuisine
     *
     * @param MyApp\GlobalBundle\Entity\Cuisines $cuisine
     */
    public function setCuisine(\MyApp\GlobalBundle\Entity\Cuisines $cuisine)
    {
     ...
     * Get cuisine
     *
     * @return MyApp\GlobalBundle\Entity\Cuisines 
     */
