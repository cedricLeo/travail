...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_province_categorieRepository")
 * @ORM\Table(name = "texte_province_categorie")
 */
class Texte_province_categorie {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Categories_hebergements", inversedBy = "Texte_province_categorie", cascade={"persist"} )
     * 
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Categories_hebergements $categorieHebergement
     */
    public function setCategorieHebergement(\MyApp\GlobalBundle\Entity\Categories_hebergements $categorieHebergement)
    {
     ...
     *
     * @return MyApp\GlobalBundle\Entity\Categories_hebergements 
     */
