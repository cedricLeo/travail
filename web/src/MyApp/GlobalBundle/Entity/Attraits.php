...
use MyApp\GlobalBundle\Entity\Galerie_attraits;
...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\AttraitsRepository")
...
/**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MyApp\GlobalBundle\Entity\Politique_en", cascade={"persist", "remove"})
     */
    private $politique_attrait_en;

    /**
     * @ORM\ManyToOne(targetEntity="MyApp\GlobalBundle\Entity\Textes_attrait_fr", cascade={"persist", "remove"})
     */
    private $description_attrait_fr;

    /**
     * @ORM\ManyToOne(targetEntity="MyApp\GlobalBundle\Entity\Textes_attrait_en", cascade={"persist", "remove"})
     */
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Galerie_attraits $galerieAttraits
     */
    public function addGalerieAttraits(\MyApp\GlobalBundle\Entity\Galerie_attraits $galerieAttraits)
    {
            //$this->galerie_attraits[] = $galerieAttraits;
     ...
     *
     * @return MyApp\GlobalBundle\Entity\Qcs_thematiques_attraits 
     */
     ...
     * Add type_soins_id
     *
     * @param MyApp\GlobalBundle\Entity\Types_soins_sante $typeSoinsId
     */
    public function addTypes_soins_sante(\MyApp\GlobalBundle\Entity\Types_soins_sante $typeSoinsId)
    {
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Qcs_thematiques_attraits $qcsThematiqueAttraitId
     */
    public function addQcs_thematiques_attraits(\MyApp\GlobalBundle\Entity\Qcs_thematiques_attraits $qcsThematiqueAttraitId)
    {
     ...
     * @param MyApp\GlobalBundle\Entity\Qcs_thematiques_attraits $qcsThematiqueAttraitId
     */
    public function setQcsThematiqueAttraitId(\MyApp\GlobalBundle\Entity\Qcs_thematiques_attraits $qcsThematiqueAttraitId)
    {
        $this->qcs_thematique_attrait_id = $qcsThematiqueAttraitId;
    }
     ...
     * Add videos
     *
     * @param MyApp\GlobalBundle\Entity\Videos $videos
     */
    public function addVideos(\MyApp\GlobalBundle\Entity\Videos $videos)
    {
        $this->videos[] = $videos;
    }
     ...
     * Add coupon_id
     *
     * @param MyApp\GlobalBundle\Entity\Coupons $couponId
     */
    public function addCoupons(\MyApp\GlobalBundle\Entity\Coupons $couponId)
    {
     ...
     * @param MyApp\GlobalBundle\Entity\Galerie_attraits $galerieAttraits
     */
    public function addGalerie_attraits(\MyApp\GlobalBundle\Entity\Galerie_attraits $galerieAttraits)
    {
        $this->galerie_attraits[] = $galerieAttraits;
    }
     ...
     */
    public function addQcs_echos_attraits(\MyApp\GlobalBundle\Entity\Qcs_echos_attraits $qcsEchoAttraitId)
    {
     ...
     * Add distance_id
     *
     * @param MyApp\GlobalBundle\Entity\Distances_attraits $distanceId
     */
    public function addDistances(\MyApp\GlobalBundle\Entity\Distances_attraits $distanceId)
    {
     ...
     * @param MyApp\GlobalBundle\Entity\Distances_attraits $distanceId
     */
    public function addDistances_attraits(\MyApp\GlobalBundle\Entity\Distances_attraits $distanceId)
    {
        $this->distance_id[] = $distanceId;
    }
     ...
     */
    public function addAttraits_categories(\MyApp\GlobalBundle\Entity\Attraits_categories $categorieAttrait)
    {
