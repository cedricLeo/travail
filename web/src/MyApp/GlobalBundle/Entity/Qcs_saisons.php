...
class Qcs_saisons
{
	...
	*/
     ...
     */
    public function addQcs_thematiques(\MyApp\GlobalBundle\Entity\Qcs_thematiques $qcsThematiqueId)
    {
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Qcs_types_forfaits $qcsTypeForfaitId
     */
    public function addQcs_types_forfaits(\MyApp\GlobalBundle\Entity\Qcs_types_forfaits $qcsTypeForfaitId)
    {
     ...
     */
    public function setQcsRegionVedetteId(\MyApp\GlobalBundle\Entity\Qcs_regions_vedettes $qcsRegionVedetteId)
    {
     ...
     *
     * @return MyApp\GlobalBundle\Entity\Qcs_regions_vedettes 
     */
     ...
     */
    public function setForfaitId(\MyApp\GlobalBundle\Entity\Forfaits $forfaitId)
    {
