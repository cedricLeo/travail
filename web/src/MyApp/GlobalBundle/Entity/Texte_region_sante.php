...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_region_santeRepository")
 * @ORM\Table(name = "texte_region_sante")
 */
class Texte_region_sante {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_sante")
     * 
     * @var integer $region
     */
    private $region;
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Types_soins_sante", inversedBy = "Texte_region_sante")
     * 
     * @var integer $sante
     */
    private $sante;
