...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\CouponsRepository")
...
class Coupons{
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Attraits $attraitCouponId
     */
    public function setAttraitCouponId(\MyApp\GlobalBundle\Entity\Attraits $attraitCouponId)
    {
