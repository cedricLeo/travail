...
class HebergementsRepository extends EntityRepository
{
		...
		{
			$sql = 'SELECT p.id, p.nom_fr FROM MyAppGlobalBundle:Hebergements p';
		...
		{
			$sql = 'SELECT p.id, p.nom_fr, p.nom_en FROM MyAppGlobalBundle:Hebergements p WHERE p.aprouver = 1 AND p.actif = 1';
			$query = $this->getEntityManager()->createQuery($sql);
			return $query->getResult();
		}
		...
		public function getAdminHebergement($page, $limit)
		{
			...
			$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif FROM MyAppGlobalBundle:Hebergements p ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
		...
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
			return $query->getResult();
		...
		{
			$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr LIKE :letter';
			$query = $this->getEntityManager()->createQuery($sql);
		...
		{	
			$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif, q.id, q.username FROM MyAppGlobalBundle:Hebergements p JOIN p.utilisateur q WHERE q.username =:word OR p.nom_fr = :word OR p.nom_en =:word ';
			$query = $this->getEntityManager()->createQuery($sql);
		...
		{	
			$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr = :word OR p.utilisateur =:word';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('word', $word);
			return $query->getResult();
		}
		...
		{
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :reg AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat GROUP BY p.ville_id';
		...
		{
			$sql = 'SELECT COUNT(q.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements q';
			$query = $this->getEntityManager()->createQuery($sql);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT q, r FROM MyAppGlobalBundle:Hebergements q JOIN q.categorie_hebergement_id r WHERE q.region_id = :reg AND r.id = :cat';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('reg', $reg);
			$query->setParameter('cat', $cat);
			return $query->getResult();
		...
		{
			$dql = 'SELECT p, q, COUNT(p.id) AS nbh FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE q.id = :id GROUP BY q.id';
			$query = $this->getEntityManager()->createQuery($dql);
		...
		{
			$dql = 'SELECT p, q, COUNT(p.id) AS nbhr FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :region AND p.aprouver = 1 AND p.actif = 1 AND q.id = :id GROUP BY q.id';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('id', $id);
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.id IN (:u) AND p.aprouver = 1 AND p.actif = 1 AND q.id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p INNER JOIN p.client_id q WHERE p.id = :id AND p.actif = 1 AND p.aprouver = 1';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			return $this->_em->createQuery('SELECT p.id, p.nom_fr FROM MyAppGlobalBundle:Hebergements p ')->getResult();
		}
		...
		{
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q  WHERE p.region_id = :reg AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat ORDER BY p.nom_fr';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('cat', $cat);
			$query->setParameter('reg', $reg);
			return $query->getResult();
		...
		public function getAllCustomerByRegionAndCategoryFiltreChoix($cat, $reg, $choix, $page, $limit)
		{
			if($choix == 1){ 
				...
				$paginator = ($page - 1) * $limit;
				$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :reg AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat AND p.classification_id IN (:class) ORDER BY p.classification';
				$query = $this->getEntityManager()->createQuery($dql);
				$query->setParameter('cat', $cat);
				$query->setParameter('reg', $reg);
				...
				return $query->getResult();
                                ...
                                $paginator = ($page - 1) * $limit;
				$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :reg AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat ORDER BY p.prix_a_partir';
				$query = $this->getEntityManager()->createQuery($dql);
				$query->setParameter('cat', $cat);
				$query->setParameter('reg', $reg);
				$query->setFirstResult($paginator);
		...
		{
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.ville_id = :reg AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat ';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('cat', $cat);
			$query->setParameter('reg', $reg);
			return $query->getResult();
		...
		{
			$paginator = ($page - 1) * $limit;
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :reg AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('cat', $cat);
			$query->setParameter('reg', $reg);
			$query->setFirstResult($paginator);
		...
		{
			$paginator = ($page - 1) * $limit;
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.ville_id = :ville AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('cat', $cat);
		...
		{
			$dql = 'SELECT p.id, p.nom_fr, p.nom_en, q  FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE q.id = :cat';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('cat', $cat);
			return $query->getResult();
		}	
		...
		{
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.province_id = :id AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('id', $id);
		...
		{
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE q.id = :cat AND p.province_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.region_id';
			$query = $this->getEntityManager()->createQuery($dql);
			$query->setParameter('id', $id);
			$query->setParameter('cat', $catHeberg);
			return $query->getResult();
		...
		{	
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.id IN (:u, :v, :x, :y, :z)';
			$query = $this->getEntityManager()->createQuery($sql);
		...
		{
			$dql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :id AND q.id is not null GROUP BY q.id';
			$query = $this->getEntityManager()->createQuery($dql);
		...
		{	
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.region_id = :id AND p.aprouver = 1 AND p.actif = 1';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			$query->setMaxResults($limit);
			return $query->getResult();
		...
		{
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.province_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.province_id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.province_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.region_id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :id AND p.aprouver = 1 AND p.actif = 1 AND q.id = 7';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
		...
		{
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE q.id =:cat AND p.aprouver = 1 AND p.actif = 1 AND p.region_id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			$query->setParameter('cat', $cat);
			$query->setMaxResults(5);
		...
		{			
                        $limit = 5;
                        $sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id =:geo AND p.aprouver = 1 AND p.actif = 1 AND q.id = :id ';
                        $query = $this->getEntityManager()->createQuery($sql);
                        $query->setParameter('id', $id);
                ...
                /**
		 * Affiche un client approuvé qui est de la catégorie d'hébergement demandée pour la section hébergement
		 */
		public function getAfficheUnClientParCategorieHebergement($id, $geographie)
		{	
                        $sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE q.id = :id AND p.province_id IN (:geo) AND p.actif = 1 AND p.aprouver = 1 ';
                        $query = $this->getEntityManager()->createQuery($sql);
                        $query->setParameter('id', $id);
                        $query->setParameter('geo', $geographie);
                        return $query->getResult();	
                ...
                /**
		 * Affiche un client approuvé pour la région qui est de la catégorie d'hébergement demandée pour la section hébergement
		 */
		public function getAfficheUnClientParCategorieHebergementRegion($id, $geographie)
		{	
                        $sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE q.id = :id AND p.region_id = :geo AND p.actif = 1 AND p.aprouver = 1 ';
                        $query = $this->getEntityManager()->createQuery($sql);
                        $query->setParameter('id', $id);
                        $query->setParameter('geo', $geographie);
                        return $query->getResult();	
                ...
                /**
		 * Affiche un client approuvé pour la ville qui est de la catégorie d'hébergement demandée pour la section hébergement
		 */
		public function getAfficheUnClientParCategorieHebergementVille($id, $geographie)
		{	
                        $sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE  p.ville_id = :geo AND p.aprouver = 1 AND p.actif = 1 AND q.id = :id';
                        $query = $this->getEntityManager()->createQuery($sql);
                        $query->setParameter('id', $id);
                        $query->setParameter('geo', $geographie);
                        return $query->getResult();
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.region_id = :region AND p.aprouver = 1 AND p.actif = 1 AND q.id = :cat ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('cat', $cat);
			$query->setParameter('region', $region);
			$query->setMaxResults($limit);
		...
		{
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.id = :id AND p.aprouver = 1 AND p.actif = 1';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.categorie_hebergement_id q WHERE p.aprouver = 1 AND p.actif = 1 AND q.id = :id ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.actif = 1 AND p.aprouver = 1 AND ( p.repertoire_fr = :nom OR p.repertoire_en = :nom)';
			$query = $this->getEntityManager()->createQuery($sql);
		...
		public function getRechercheNomHebergement($word)
		{
                    ...
                    $sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr LIKE :word AND p.aprouver = 1 and p.actif = 1 OR p.nom_en LIKE :word AND p.aprouver = 1 and p.actif = 1';
                    $query = $this->getEntityManager()->createQuery($sql);
                    $query->setParameter('word', $word);  
                    if(count($query->getResult()) > 1 or $query->getResult() == null )
                    {                        
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr LIKE :word AND p.aprouver = 1 and p.actif = 1 OR p.nom_en LIKE :word AND p.aprouver = 1 and p.actif = 1';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('word', '%'.$word);                       		
                ...
                /**
                 * Recherche avec tous les mots du moteur de recherche
                 */
                public function getRechercheTout($word)
                {
                    $nb_affiche = 10;
                    $word = html_entity_decode($word);
                    $tab = [];
                    ...
                    if(empty($tab[0])){          
                        $nb_mot = str_word_count($word, 1);                                  
                        $sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr LIKE :word AND p.aprouver = 1 and p.actif = 1 OR p.nom_en LIKE :word AND p.aprouver = 1 and p.actif = 1';
                        $query = $this->getEntityManager()->createQuery($sql);  
                        foreach($nb_mot as $key){
                            $query->setParameter('word', '%'.$key.'%' ); 
                            $query->setMaxResults($nb_affiche);
                            array_push($tab, $query->getResult() );
                        }
		...
		{
			$sql = 'SELECT p, q, r, s FROM MyAppGlobalBundle:Hebergements p JOIN p.devise_id q JOIN p.style_hebergement_id r JOIN p.hebergement_paiements_id s WHERE p.id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
                ...
                {
                        $sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.devise_id q WHERE p.id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
                }
		...
		{       
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.style_hebergement_id q WHERE  p.ville_id = :ville AND p.actif = 1 AND p.aprouver = 1 AND q.id IN (:styleHeb) AND p.id <> :idclient ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('ville', $ville);
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_service_id q WHERE p.id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.id = :id';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.province_id =:id AND q.id is not null GROUP BY p.region_id ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.region_id =:id AND q.id is not null GROUP BY p.id ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
		...
		public function getActivitesHebergementRegionPaginate($id, $page, $limit)
		{
			...
			return $query->getResult();
                ...
                /**
		 * Récupère les hébergements pour la région avec la pagination version mobile
		 */
		public function getAfficheRegion($region, $page, $limit )
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.region_id =:id AND q.id is not null GROUP BY p.id ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $region);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
			return $query->getResult();
		}
                ...
                /**
		 * Pagination des hébergeemnts avec une province sélectionnée version mobile
		 */
		public function getAfficheProvince($province, $page, $limit )
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.province_id =:id AND q.id is not null GROUP BY p.id ';
			$query = $this->getEntityManager()->createQuery($sql);
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.region_id =:id AND q.id is not null GROUP BY p.ville_id ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.ville_id =:id AND q.id is not null GROUP BY p.id ';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $id);
			return $query->getResult();
		}
		...
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.region_id = :region ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
			$query->setParameter('region', $region);
		...
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.zone_id = :zone ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
		...
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.ville_id = :ville ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
			$query->setParameter('ville', $ville);
		...
		{	
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.actif = :actif ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
		...
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.actif = :inactif ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
		...
		{
			$paginator = ($page - 1) * $limit;
			$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr LIKE :lettre ORDER BY p.nom_fr ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setFirstResult($paginator);
			$query->setMaxResults($limit);
		...
		{
			$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.aprouver = 0';
			$query = $this->getEntityManager()->createQuery($sql);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.actif = 1';
			$query = $this->getEntityManager()->createQuery($sql);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.actif = 0';
			$query = $this->getEntityManager()->createQuery($sql);
			return $query->getResult();
		}
		...
		{
			$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.region_id = :region';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('region', $region);
			return $query->getResult();
		}
	    ...
	    {
	    	$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.zone_id = :zone';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('zone', $zone);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.ville_id = :ville';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('ville', $ville);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT COUNT(p.id) AS nbHebergement FROM MyAppGlobalBundle:Hebergements p WHERE p.nom_fr LIKE :word';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('word', $word.'%');
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.region_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.ville_id';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_activite_id q WHERE p.id = :id ORDER BY q.nom_fr ASC';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	     ...
	     */
	    public function getAfficheProvinceAccueil($id)
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.province_id = :id AND p.actif = 1 AND p.aprouver = 1';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	$query->setMaxResults(1);
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.region_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.region_id';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.ville_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.ville_id';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p JOIN p.province_id q WHERE q.pays_id = :pays AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.province_id';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    ...
	    {
	    	$sql = 'SELECT MAX(p.id) AS lastid FROM MyAppGlobalBundle:Hebergements p ';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.id = :id AND p.repertoire_fr = :nom AND p.utilisateur = :client OR p.id = :id AND p.repertoire_en = :nom AND p.utilisateur = :client';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.id = :id AND p.repertoire_fr = :word OR p.id =:id AND p.repertoire_en = :word';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.utilisateur = :id AND p.actif = 1 AND p.aprouver = 1 OR p.utilisateur = :id AND p.actif = 0 AND p.aprouver = 1';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.utilisateur = :id ';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    /**
	     * Affiche les provinces qui ont des établissements 
	     */
	    public function getAfficheProvincesFooterHotel($id)
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.province_id = :id AND p.aprouver = 1 AND p.actif = 1 GROUP BY p.region_id';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    ...
	    {
	    	$sql = 'SELECT p, q FROM MyAppGlobalBundle:Hebergements p JOIN p.calendrier q WHERE p.id = :id ';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p WHERE p.id IN (:id) AND p.actif = 1 AND p.aprouver = 1';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	$query->setParameter('id', $id);
	    	return $query->getResult();
	    }
	    ...
	    {
	    	$sql = 'SELECT p FROM MyAppGlobalBundle:Hebergements p GROUP BY p.province_id ';
	    	$query = $this->getEntityManager()->createQuery($sql);
	    	return $query->getResult();
	    }
