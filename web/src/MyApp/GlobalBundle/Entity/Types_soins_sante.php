...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Types_soins_santeRepository")
...
class Types_soins_sante{
     ...
     * Add soins_client
     *
     * @param MyApp\GlobalBundle\Entity\Soins_client $soinsClient
     */
    public function addSoins_client(\MyApp\GlobalBundle\Entity\Soins_client $soinsClient)
    {
