...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_region_corporatifRepository")
 * @ORM\Table(name = "texte_region_corporatif")
 */
class Texte_region_corporatif {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_corporatif")
     * 
     * @var integer $region
     */
    private $region;
