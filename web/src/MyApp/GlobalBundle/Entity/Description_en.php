...
class Description_en{
    ...
    /**
     * @ORM\OneToMany(targetEntity="MyApp\GlobalBundle\Entity\Hebergements", mappedBy="Description_en")
     */
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Hebergements $hebergementDescriptionEn
     */
