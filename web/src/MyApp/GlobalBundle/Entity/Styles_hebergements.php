...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Styles_hebergementsRepository")
...
class Styles_hebergements{
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Hebergements $styleHebergement
     */
    public function addHebergements(\MyApp\GlobalBundle\Entity\Hebergements $styleHebergement)
    {
