...
class AttraitsRepository extends EntityRepository{
	...
	{
		$sql = 'SELECT p.id, p.nom_fr FROM MyAppGlobalBundle:Attraits p';
	...
	{
		$sql = 'SELECT p.id, p.nom_fr, p.nom_en FROM MyAppGlobalBundle:Attraits p WHERE p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	public function getAdminAttraitTBClient($page, $limit)
	{
		...
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p ORDER BY p.nom_fr ASC';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif, q.id, q.username FROM MyAppGlobalBundle:Attraits p JOIN p.utilisateur q WHERE p.nom_fr = :word OR p.utilisateur =:word OR q.username =:word';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif FROM MyAppGlobalBundle:Attraits p WHERE p.nom_fr = :word OR p.utilisateur =:word ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('word', $searchword);
		return $query->getResult();
	}
	...
	public function getRechercheAttrait($searchword)
	{
		...
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.nom_fr LIKE :word AND p.approuve = 1 AND p.actif = 1 OR p.nom_en LIKE :word AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('word', '%'.$searchword.'%');
		return $query->getResult();
	}
	...
	{
		$paginator = ($page - 1) * $limit;
		$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif FROM MyAppGlobalBundle:Attraits p ORDER BY p.nom_fr ASC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setFirstResult($paginator);
		$query->setMaxResults($limit);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.actif FROM MyAppGlobalBundle:Attraits p WHERE p.nom_fr LIKE :letter';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id IN (:tab) AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$paginator = ($page - 1)* $limit;
		//$sql = 'SELECT p.id, p.nom_fr, p.nom_en, p.image, p.texte_resume_fr, p.texte_resume_en, p.repertoire_fr, p.repertoire_en FROM MyAppGlobalBundle:Attraits p WHERE p.id IN (:tab) AND p.approuve = 1';
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id IN (:tab) AND p.approuve = 1 and p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('tab', $tab);
		$query->setFirstResult($paginator);
	...
	{
		$sql = 'SELECT COUNT(p.id) AS nbActif FROM MyAppGlobalBundle:Attraits p WHERE p.approuve = 1 and p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p.id, p.latitude, p.longitude, p.date_creation FROM MyAppGlobalBundle:Attraits p WHERE p.id <> :id AND p.approuve = 1 AND p.actif = 1 AND p.latitude is not null AND p.longitude is not null AND p.latitude != 0 AND p.longitude != 0 ';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id = :id AND p.repertoire_fr = :nom AND p.utilisateur = :client OR p.id = :id AND p.repertoire_en = :nom AND p.utilisateur = :client';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id = :id AND p.repertoire_fr = :repertoire OR p.id = :id AND p.repertoire_en = :repertoire';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:attraits p WHERE p.utilisateur = :client';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p.id, p.nom_fr, p.nom_en FROM MyAppGlobalBundle:attraits p WHERE p.categorie_attrait = :cat';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:attraits p WHERE p.nom_fr = :client';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait is not null GROUP BY p.categorie_attrait ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :id AND p.categorie_attrait is not null GROUP BY p.categorie_attrait  ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait is not null';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :id AND p.categorie_attrait is not null ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :id AND p.categorie_attrait is not null GROUP BY p.ville_id  ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.ville_id = :id AND p.categorie_attrait is not null GROUP BY p.ville_id  ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.ville_id = :id AND p.categorie_attrait is not null GROUP BY p.categorie_attrait';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{	
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait is not null GROUP BY p.province_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait is not null AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait = :catResto AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.cuisine_id q WHERE p.province_id = :id AND p.categorie_attrait = :catResto AND p.approuve = 1 AND p.actif = 1 ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setParameter('catResto', $catResto);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait = :catResto AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setParameter('catResto', $catResto);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id IN ( :qc, :on, :nb) AND p.categorie_attrait is not null AND p.approuve = 1 AND p.actif = 1 GROUP BY p.categorie_attrait ';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id IN ( :qc, :on, :nb) AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1 GROUP BY p.categorie_attrait ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('qc', $tab[0]);
		$query->setParameter('on', $tab[1]);
		$query->setParameter('nb', $tab[2]);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.categorie_attrait is not null GROUP BY p.categorie_attrait';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$paginator = ($page - 1)* $limit;
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1 GROUP BY p.ville_id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('reg', $reg);
		$query->setParameter('cat', $cat);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.hebergement_id is not null AND p.approuve = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('reg', $reg);
		$query->setParameter('cat', $cat);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.hebergement_id is not null AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('reg', $reg);
		$query->setParameter('cat', $cat);
		return $query->getResult();
	...
	public function getSuggestionCategoriesAttraits($region, $tab)
	{
		...
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :region  AND p.categorie_attrait =:cat GROUP BY p.categorie_attrait ';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :prov  AND p.categorie_attrait =:cat GROUP BY p.region_id ORDER BY p.nom_fr ASC OR p.nom_en ASC';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.ville_id = :ville';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('cat', $cat);
		$query->setParameter('reg', $reg);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.cotation_id = :cotation';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('cat', $cat);
		$query->setParameter('reg', $reg);
	...
	{
		$sql = 'SELECT COUNT(p.id) AS resultList FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :reg AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('cat', $cat);
		$query->setParameter('reg', $reg);
		return $query->getResult();
	...
	{
		$sql = 'SELECT COUNT(p.id) AS resultList FROM MyAppGlobalBundle:Attraits p WHERE p.ville_id = :ville AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('cat', $cat);
		$query->setParameter('ville', $ville);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait = 11 GROUP BY p.province_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait = 11 AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p INNER JOIN p.cuisine_id q WHERE p.region_id = :region ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('region', $region);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p INNER JOIN p.cuisine_id q WHERE p.id IN (:tab) AND p.approuve = 1 AND p.actif = 1 GROUP BY q.nom_fr ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('tab', $tab);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p INNER JOIN p.cuisine_id q WHERE p.id IN (:tab) AND p.approuve = 1 AND p.actif = 1 GROUP BY q.nom_en ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('tab', $tab);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p INNER JOIN p.cuisine_id q WHERE p.province_id = :id GROUP BY p.region_id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id IN (:id1, :id2, :id3, :id4) AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p INNER JOIN p.cuisine_id q WHERE p.id IN (:id1, :id2, :id3) AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id1', $tab[0]);
		$query->setParameter('id2', $tab[1]);
		$query->setParameter('id3', $tab[2]);
	...
	{
		$sql = 'SELECT COUNT(p.id) AS nbresult FROM MyAppGlobalBundle:Attraits p WHERE p.categorie_attrait = :cat AND p.region_id = :reg AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('reg', $reg);
		$query->setParameter('cat', $cat);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.categorie_attrait = :cat AND p.region_id = :reg AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('reg', $reg);
		$query->setParameter('cat', $cat);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.cuisine_id q WHERE p.categorie_attrait = :cat AND p.region_id = :reg AND q.id = :cuisine AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('reg', $reg);
		$query->setParameter('cat', $cat);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.nom_fr = :name OR p.nom_en = :name ';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p, q, r, s, t, u FROM MyAppGlobalBundle:Attraits p INNER JOIN p.paiement_id q INNER JOIN p.cuisine_id r INNER JOIN p.attrait_service_id s INNER JOIN p.lundi_matin_ete t INNER JOIN p.devise_id u WHERE p.id = :id AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$paginator = ($page - 1) * $limit;
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.ville_id = :ville AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('ville', $ville);
		$query->setParameter('cat', $cat);
		$query->setFirstResult($paginator);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :id AND p.categorie_attrait = :cat AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setParameter('cat', $cat);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.cuisine_id q WHERE p.categorie_attrait = 11 AND p.province_id = :province AND p.approuve = 1 AND p.actif = 1 AND q.id = :specialite GROUP BY p.province_id ';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.cuisine_id q WHERE p.categorie_attrait = 11 AND p.province_id = :province AND p.approuve = 1 AND p.actif = 1 AND q.id = :specialite GROUP BY p.region_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('specialite', $specialite);
		$query->setParameter('province', $province);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.province_id = :province AND p.categorie_attrait = 5 AND p.approuve = 1 AND p.actif = 1 GROUP BY p.province_id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('province', $province);
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q WHERE p.province_id = :id AND q.id <> 126 AND p.categorie_attrait = 5 AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q WHERE p.categorie_attrait = 5 AND q.id <> 126 AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q WHERE p.region_id = :id AND q.id <> 126 AND p.categorie_attrait = 5 AND p.approuve = 1 AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setMaxResults($limit);
		return $query->getResult();
	...
	{
		$limit = 5;
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.type_soins_id q WHERE p.region_id = :id AND p.categorie_attrait = 5 AND p.approuve = 1 AND p.actif = 1 AND q.id = :soin ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.type_soins_id q WHERE p.province_id = :id AND q.id = :soin AND p.approuve = 1 AND p.actif = 1 GROUP BY p.region_id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setParameter('soin', $soin);
		return $query->getResult();
	...
	public function getTypeSoinRechercheParRegion($id, $soin, $page, $limit)
	{
		...
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.type_soins_id q WHERE p.region_id = :id AND q.id = :soin AND p.approuve = 1 AND p.actif = 1 GROUP BY p.ville_id';
		}
		if($page != null and $limit != null)
		{
			$paginator = ($page - 1) * $limit;
	...
	public function getTypeSoinRechercheParVille($id, $soin, $page, $limit)
	{
		...
		if($page == null and $limit == null)
		{
			$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.type_soins_id q WHERE p.ville_id = :id AND q.id = :soin AND p.approuve = 1 AND p.actif = 1';
		}
		if($page != null and $limit != null)
		{
			$paginator = ($page - 1) * $limit;
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.repertoire_fr = :nom OR p.repertoire_en = :nom';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id =:id AND p.repertoire_fr = :nom OR p.repertoire_en = :nom';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('nom', $searchword);
		$query->setParameter('id', $id);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id = :id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
    ...
    {
        $sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.hebergement_id = :id';
        $query = $this->getEntityManager()->createQuery($sql);
        $query->setParameter('id', $id);
        return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q WHERE p.hebergement_id = :id';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('id', $id);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q WHERE p.utilisateur = :id';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('id', $id);
    	if($query->getResult() == null){
    		$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.utilisateur = :id';
    		$query = $this->getEntityManager()->createQuery($sql);
    		$query->setParameter('id', $id);
    	}
    	return $query->getResult();
    ...
    {
    	$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q WHERE p.id = :id';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('id', $id);
    	return $query->getResult();
    }
    ...
    {
    	$paginator = ($page - 1) * $limit;
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :region ORDER BY p.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setFirstResult($paginator);
    	$query->setMaxResults($limit);
    	$query->setParameter('region', $region);
    ...
    {
    	$paginator = ($page - 1) * $limit;
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.zone_id = :zone ORDER BY p.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setFirstResult($paginator);
    	$query->setMaxResults($limit);
    ...
    {
    	$paginator = ($page - 1) * $limit;
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.ville_id = :ville ORDER BY p.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setFirstResult($paginator);
    	$query->setMaxResults($limit);
    	$query->setParameter('ville', $ville);
    ...
    {
    	$paginator = ($page - 1) * $limit;
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.actif = :actif ORDER BY p.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setFirstResult($paginator);
    	$query->setMaxResults($limit);
    ...
    {
    	$paginator = ($page - 1) * $limit;
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.actif = :inactif ORDER BY p.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setFirstResult($paginator);
    	$query->setMaxResults($limit);
    ...
    {
    	$paginator = ($page - 1) * $limit;
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.nom_fr LIKE :lettre  ORDER BY p.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setFirstResult($paginator);
    	$query->setMaxResults($limit);
    ...
    {
    	$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p WHERE p.actif = 1';
    	$query = $this->getEntityManager()->createQuery($sql);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p WHERE p.actif = 0';
    	$query = $this->getEntityManager()->createQuery($sql);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p WHERE p.region_id = :region';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('region', $region);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p WHERE p.zone_id = :zone';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('zone', $zone);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p WHERE p.ville_id = :ville';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('ville', $ville);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT COUNT(p.id) AS nbAttrait FROM MyAppGlobalBundle:Attraits p WHERE p.nom_fr LIKE :word';
    	$query = $this->getEntityManager()->createQuery($sql);
    ...
    {
    	$sql = 'SELECT p, q FROM MyAppGlobalBundle:Attraits p JOIN p.attrait_service_id q ORDER BY q.nom_fr ASC';
    	$query = $this->getEntityManager()->createQuery($sql);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.id = :client AND p.approuve = 1 AND p.actif = 1';
    	$query = $this->getEntityManager()->createQuery($sql);
    ...
    {
    	$sql = 'SELECT p, q, r FROM MyAppGlobalBundle:Attraits p JOIN p.soins_sante_id q JOIN p.type_soins_id r  WHERE p.id = :client AND p.approuve = 1 AND p.actif = 1';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('client', $client);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.approuve = 1 AND p.actif = 1 AND p.province_id = :id';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('id', $id);
    	$query->setMaxResults($limit);
    	return $query->getResult();
    ...
    {
    	$sql = 'SELECT p FROM MyAppGlobalBundle:Attraits p WHERE p.approuve = 1 AND p.actif = 1 AND p.province_id = :id GROUP BY p.region_id';
    	$query = $this->getEntityManager()->createQuery($sql);
    	$query->setParameter('id', $id);
    	return $query->getResult();
    }
    ...
    {
    	$sql = 'SELECT MAX(p.id) AS lastid FROM MyAppGlobalBundle:Attraits p ';
    	$query = $this->getEntityManager()->createQuery($sql);
    	return $query->getResult();
    }
