...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_region_activite_corporativeRepository")
 * @ORM\Table(name = "texte_region_activite_corporative")
 */
class Texte_region_activite_corporative {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_activite_corporative")
     * 
     * @var integer $region
     */
    private $region;
