...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Texte_region_forfait_affaireRepository")
 * @ORM\Table(name = "texte_region_forfait_affaire")
 */
class Texte_region_forfait_affaire {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_forfait_affaire")
     * 
     * @var integer $region
     */
    private $region;
