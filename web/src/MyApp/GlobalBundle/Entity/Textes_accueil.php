...
class Textes_accueil {
	...
	private $texte_accueil_restaurant_fr;
        ...
        /**
	 * @ORM\ManyToOne(targetEntity="MyApp\GlobalBundle\Entity\Texte_complementaire_section_principale", cascade={"persist"})
	 * 
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Texte_complementaire_section_principale $texteComplementaire
     */
    public function setTexteComplementaire(\MyApp\GlobalBundle\Entity\Texte_complementaire_section_principale $texteComplementaire)
    {
     ...
     *
     * @return MyApp\GlobalBundle\Entity\Texte_complementaire_section_principale 
     */
