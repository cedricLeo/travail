...
class ChambresRepository extends EntityRepository
{
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p ORDER BY p.id DESC';
	...
	public function getChambres($page, $limit)
	{
		...
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p ORDER BY p.nom_fr ASC';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p WHERE p.nom_fr LIKE :letter';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT COUNT(p.id) AS nbchambre FROM MyAppGlobalBundle:Chambres p';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p WHERE p.nom_fr=:wordfr';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p WHERE p.hebergement =:id';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p WHERE p.hebergement =:id AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	public function getRetourneChambreLaMoinsChere($id)
	{
		$tab = array();
		foreach($id as $tw){
			$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p WHERE p.hebergement = :id AND p.actif = 1 ORDER BY p.tarif_min_basse_saison ASC';
			$query = $this->getEntityManager()->createQuery($sql);
	...
	public function getRetourneChambreAffaireLaMoinsChere($id)
	{
		$tab = array();
		foreach($id as $tw){
			$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q WHERE p.hebergement = :id AND p.actif = 1 AND q.id = 18 ORDER BY p.tarif_min_basse_saison ASC';
			$query = $this->getEntityManager()->createQuery($sql);
			$query->setParameter('id', $tw);
			$query->setMaxResults(1);
			array_push($tab, $query->getResult());
	...
	{
		$sql = 'SELECT p, q, r FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q JOIN p.equipement_id r WHERE p.hebergement =:id AND p.actif = 1 ORDER BY p.ordre_affichage ASC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.equipement_id q WHERE p.hebergement =:id AND p.id NOT IN (:tab) AND p.actif = 1 ORDER BY p.ordre_affichage ASC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.equipement_id q WHERE p.hebergement =:id AND p.ordre_affichage IN (:tab) AND p.actif = 1 GROUP BY q.id ORDER BY p.ordre_affichage';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setParameter('tab', $tab);
		return $query->getResult();
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q WHERE p.hebergement =:id ORDER BY p.ordre_affichage ASC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Chambres p WHERE p.hebergement =:id ORDER BY p.ordre_affichage ASC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q, COUNT(p.id) AS nbchambre FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q WHERE p.hebergement =:id ORDER BY p.ordre_affichage ASC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q JOIN p.hebergement r WHERE q.id = 18 ';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q JOIN p.hebergement r WHERE q.id = 18 AND r.province_id =:id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q JOIN p.hebergement r WHERE q.id = 18 AND r.region_id =:id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q JOIN p.hebergement r WHERE q.id = 18 AND r.ville_id =:id ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q FROM MyAppGlobalBundle:Chambres p JOIN p.type_chambre_id q JOIN p.hebergement r WHERE q.id = 18 AND r.region_id IN (:id) ';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
	...
	{
		$sql = 'SELECT p FROM MyAppGlobalBundle:Types_chambres p ORDER BY p.nom_fr';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, q, r FROM MyAppGlobalBundle:Hebergements p JOIN p.hebergement_type_chambre q JOIN q.chambre_id r WHERE p.id =:id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p.id FROM MyAppGlobalBundle:Chambres p WHERE p.hebergement = :id ORDER BY p.id DESC';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		$query->setMaxResults(1);
		return $query->getResult();
