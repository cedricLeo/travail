...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Soins_SanteRepository")
...
class Soins_sante{
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Types_soins_sante $typesSoinsSanteId
     */
    public function setTypesSoinsSanteId(\MyApp\GlobalBundle\Entity\Types_soins_sante $typesSoinsSanteId)
    {
     ...
     *
     * @return MyApp\GlobalBundle\Entity\Types_soins_sante 
     */
     ...
     *
     * @param MyApp\GlobalBundle\Entity\Categorie_soins_sante $categorieSoinsSanteId
     */
    public function addCategorie_soins_sante(\MyApp\GlobalBundle\Entity\Categorie_soins_sante $categorieSoinsSanteId)
    {
