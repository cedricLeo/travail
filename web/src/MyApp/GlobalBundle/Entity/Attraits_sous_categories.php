...
/**
 * @ORM\Entity(repositoryClass="MyApp\GlobalBundle\Entity\Attraits_sous_categorieRepository")
...
class Attraits_sous_categories{
     ...
     * Set categorie_id
     *
     * @param MyApp\GlobalBundle\Entity\Attraits_categories $categorieId
     */
    public function setCategorieId(\MyApp\GlobalBundle\Entity\Attraits_categories $categorieId)
    {
