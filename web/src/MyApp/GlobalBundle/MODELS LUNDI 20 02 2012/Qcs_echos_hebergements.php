...
/**
 * @ORM\Entity
 * @ORM\Table(name = "qcs_echos_hebergements")
 */
class Qcs_echos_hebergements
{
	/**
	 * @ORM\Id
	...
	/**
	 * @ORM\OneToOne(targetEntity = "Hebergements", inversedBy = "Qcs_echos_hebergements")
	...
	/**
	 * @ORM\ManyToMany(targetEntity = "Qcs_saisons", inversedBy = "Qcs_echos_hebergements")
	 * @ORM\JoinTable(name = "relations_qcs_saisons_qcs_types_saisons")
	 * 
	 * @var ArrayCollection $qcs_saison
	 */
	private $qcs_saison;
	...
	*/
	...
	{
		$this->qcs_type_saison = new ArrayCollection();
	}
     ...
     * Add qcs_type_saison
     *
     * @param MyApp\GlobalBundle\Entity\Qcs_types_saisons $qcsTypeSaison
     */
    public function addQcs_types_saisons(\MyApp\GlobalBundle\Entity\Qcs_types_saisons $qcsTypeSaison)
    {
        $this->qcs_type_saison[] = $qcsTypeSaison;
    }
     ...
     */
    public function getQcsTypeSaison()
    {
        return $this->qcs_type_saison;
    }

    /**
     * Add qcs_saison
     *
     * @param MyApp\GlobalBundle\Entity\Qcs_saisons $qcsSaison
     */
    public function addQcs_saisons(\MyApp\GlobalBundle\Entity\Qcs_saisons $qcsSaison)
    {
        $this->qcs_saison[] = $qcsSaison;
    }
     ...
     * @return Doctrine\Common\Collections\Collection 
     */
    public function getQcsSaison()
    {
        return $this->qcs_saison;
    }
}