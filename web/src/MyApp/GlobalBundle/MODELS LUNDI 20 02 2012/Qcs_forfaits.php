...
class Qcs_forfaits{
	...
	/**
	 * @ORM\OneToOne(targetEntity="Hebergements", inversedBy="Qcs_forfaits")
	 ...
	 * @ORM\JoinTable(name = "relations_forfaits_qcs_forfaits")
	 * 
