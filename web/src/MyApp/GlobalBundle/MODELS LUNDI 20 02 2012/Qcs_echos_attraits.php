...
/**
 * @ORM\Entity
 * @ORM\Table(name = "qcs_echos_attraits")
 */
class Qcs_echos_attraits{
	...
	/**
	 * @ORM\OneToOne(targetEntity="Hebergements", inversedBy="Qcs_echos_attraits")
	...
	/**
	 * @ORM\ManyToOne(targetEntity="Qcs_types_saisons", inversedBy="Qcs_echos_attraits")
	 * @ORM\JoinTable(name = "relations_qcs_types_saisons_qcs_echos_attraits")
	 * 
	 * @var integer $qcs_type_saison_id
	 */
	private $qcs_type_saison_id;
     ...
     * Set attrait_id
     *
     * @param MyApp\GlobalBundle\Entity\Hebergements $attraitId
     */
    public function setAttraitId(\MyApp\GlobalBundle\Entity\Hebergements $attraitId)
    {
