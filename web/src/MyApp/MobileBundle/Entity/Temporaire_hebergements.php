...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Temporaire_hebergementRepository")
 * @ORM\Table(name = "temporaire_hebergements", indexes={@ORM\index(name="temporaire_hebergement_idx", columns={"id"})})
 * @ORM\HasLifecycleCallbacks
 */
class Temporaire_hebergements{
     ...
     * Add url1_fr
     *
     * @param MyApp\MobileBundle\Entity\Videos $url1Fr
     */
    public function addVideos(\MyApp\MobileBundle\Entity\Videos $url1Fr)
    {
        $this->url1_fr[] = $url1Fr;
    }
}