...
class Categorie_soins_sante{
     ...
     * Set soin_sante_id
     *
     * @param MyApp\MobileBundle\Entity\Soins_sante $soinSanteId
     */
    public function setSoinSanteId(\MyApp\MobileBundle\Entity\Soins_sante $soinSanteId)
    {
     ...
     * Get soin_sante_id
     *
     * @return MyApp\MobileBundle\Entity\Soins_sante 
     */
