...
class Qcs_concours
{
	...
	*/
     ...
     * Set reglement_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_reglements $reglementId
     */
    public function setReglementId(\MyApp\MobileBundle\Entity\Qcs_reglements $reglementId)
    {
     ...
     * Get reglement_id
     *
     * @return MyApp\MobileBundle\Entity\Qcs_reglements 
     */
     ...
     * Set qcs_saison_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_Concours $qcsSaisonId
     */
    public function setQcsSaisonId(\MyApp\MobileBundle\Entity\Qcs_Concours $qcsSaisonId)
    {
