...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_restaurantRepository")
 * @ORM\Table(name = "texte_province_restaurant")
 */
class Texte_province_restaurant {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_restaurant")
     * 
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Cuisines", inversedBy = "Texte_province_restaurant")
     * 
     * @var integer $cuisine
     */
    private $cuisine;
     ...
     * Set province
     *
     * @param MyApp\MobileBundle\Entity\Provinces_etats $province
     */
    public function setProvince(\MyApp\MobileBundle\Entity\Provinces_etats $province)
    {
     ...
     * Set cuisine
     *
     * @param MyApp\MobileBundle\Entity\Cuisines $cuisine
     */
    public function setCuisine(\MyApp\MobileBundle\Entity\Cuisines $cuisine)
    {
     ...
     * Get cuisine
     *
     * @return MyApp\MobileBundle\Entity\Cuisines 
     */
