...
class Qcs_types_saisons
{
	...
	*/
     ...
     * Add qcs_saisons
     *
     * @param MyApp\MobileBundle\Entity\Qcs_saisons $qcsSaisons
     */
    public function addQcs_saisons(\MyApp\MobileBundle\Entity\Qcs_saisons $qcsSaisons)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Qcs_echos_attraits $qcsEchosAttraits
     */
    public function addQcs_echos_attraits(\MyApp\MobileBundle\Entity\Qcs_echos_attraits $qcsEchosAttraits)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Qcs_echos_clients $qcsEchosClients
     */
    public function addQcs_echos_clients(\MyApp\MobileBundle\Entity\Qcs_echos_clients $qcsEchosClients)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Qcs_echos_hebergements $qcsEchosHebergements
     */
    public function addQcs_echos_hebergements(\MyApp\MobileBundle\Entity\Qcs_echos_hebergements $qcsEchosHebergements)
    {
     ...
     * Add qcs_echos
     *
     * @param MyApp\MobileBundle\Entity\Qcs_echos $qcsEchos
     */
    public function addQcs_echos(\MyApp\MobileBundle\Entity\Qcs_echos $qcsEchos)
    {
