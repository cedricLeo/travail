 ...
 * @author leonardc
 *
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\ChambresRepository")
...
class Chambres{
     ...
     * Add type_chambre_id
     *
     * @param MyApp\MobileBundle\Entity\Types_chambres $typeChambreId
     */
    public function addTypes_chambres(\MyApp\MobileBundle\Entity\Types_chambres $typeChambreId)
    {
     ...
     * Add lit_id
     *
     * @param MyApp\MobileBundle\Entity\Lits $litId
     */
    public function addLits(\MyApp\MobileBundle\Entity\Lits $litId)
    {
        $this->lit_id[] = $litId;
    }
     ...
     * Add equipement_id
     *
     * @param MyApp\MobileBundle\Entity\Equipements $equipementId
     */
    public function addEquipements(\MyApp\MobileBundle\Entity\Equipements $equipementId)
    {
     ...
     * Add galerie_chambre
     *
     * @param MyApp\MobileBundle\Entity\Galerie_photo_chambres $galerieChambre
     */
    public function addGalerie_photo_chambres(\MyApp\MobileBundle\Entity\Galerie_photo_chambres $galerieChambre)
    {
     ...
     * Add type_prix
     *
     * @param MyApp\MobileBundle\Entity\Types_prix $typePrix
     */
    public function addTypes_prix(\MyApp\MobileBundle\Entity\Types_prix $typePrix, $em)
    {
    	if($typePrix->getPrixMin() != null and $typePrix->getPrixMax() != null and $typePrix->getCalendrierId() != null and $typePrix->getTitreHauteSaisonEn() != null and $typePrix->getTitreHauteSaisonFr() != null and $typePrix->getIndexChambre() != null){
    		...
    		$prixExiste = $em->find("MyAppMobileBundle:Types_prix", $typePrix->getId());
			if($prixExiste == null)
