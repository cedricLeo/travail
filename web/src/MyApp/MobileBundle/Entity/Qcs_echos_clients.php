...
class Qcs_echos_clients{
	...
	/**
	 * @ORM\ManyToOne(targetEntity = "Qcs_types_saisons", inversedBy = "Qcs_echos_clients")
	 *
	 * @var integer $qcs_types_saisons_id
	 */
	private $qcs_types_saisons_id;
     ...
     * Set qcs_saisons_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_saisons $qcsSaisonsId
     */
    public function setQcsSaisonsId(\MyApp\MobileBundle\Entity\Qcs_saisons $qcsSaisonsId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Qcs_types_saisons $qcsTypesSaisonsId
     */
    public function setQcsTypesSaisonsId(\MyApp\MobileBundle\Entity\Qcs_types_saisons $qcsTypesSaisonsId)
    {
