...
/**
 * @ORM\Entity
 * @ORM\Table(name = "qcs_regions_vedettes")
 */
class Qcs_regions_vedettes{
	...
	/**
	 * @ORM\OneToOne(targetEntity = "Qcs_saisons", inversedBy = "Qcs_regions_vedettes")
	...
	/**
	 * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Qcs_regions_vedettes")
	 * 
