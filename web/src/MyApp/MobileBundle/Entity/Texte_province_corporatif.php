...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_corporatifRepository")
 * @ORM\Table(name = "texte_province_corporatif")
 */
class Texte_province_corporatif {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_corporatif")
     * 
