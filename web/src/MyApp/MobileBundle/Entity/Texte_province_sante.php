...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_santeRepository")
 * @ORM\Table(name = "texte_province_sante")
 */
class Texte_province_sante {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_sante")
     * 
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Types_soins_sante", inversedBy = "Texte_province_sante")
     * 
     * @var integer $sante
     */
    private $sante;
     ...
     * Set sante
     *
     * @param MyApp\MobileBundle\Entity\Types_soins_sante $sante
     */
    public function setSante(\MyApp\MobileBundle\Entity\Types_soins_sante $sante)
    {
        $this->sante = $sante;
    }
