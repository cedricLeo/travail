...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Hebergements_salles_corporativesRepository")
...
class Hebergements_salles_corporatives
{
	...
	*/
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements $salleCorporativeHebergement
     */
    public function setSalleCorporativeHebergement(\MyApp\MobileBundle\Entity\Hebergements $salleCorporativeHebergement)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Corporatifs_services $corporatifServiceId
     */
    public function addCorporatifs_services(\MyApp\MobileBundle\Entity\Corporatifs_services $corporatifServiceId)
    {
     ...
     * Add type_evenement
     *
     * @param MyApp\MobileBundle\Entity\Types_evenements $typeEvenement
     */
    public function addTypes_evenements(\MyApp\MobileBundle\Entity\Types_evenements $typeEvenement)
    {
     ...
     * Add galerie_corpo
     *
     * @param MyApp\MobileBundle\Entity\Corporatif_galerie_photo $galerieCorpo
     */
    public function addCorporatif_galerie_photo(\MyApp\MobileBundle\Entity\Corporatif_galerie_photo $galerieCorpo)
    {
     ...
     * Add forfait_id
     *
     * @param MyApp\MobileBundle\Entity\Forfaits_clients $forfaitId
     */
    public function addForfaits_clients(\MyApp\MobileBundle\Entity\Forfaits_clients $forfaitId)
    {
