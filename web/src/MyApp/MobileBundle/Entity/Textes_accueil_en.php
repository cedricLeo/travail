...
class Textes_accueil_en {
	...
	private $texte_accueil_restaurant_meta_en;
        ...
        /**
	 * @ORM\ManyToOne(targetEntity="MyApp\MobileBundle\Entity\Texte_complementaire_section_principale_en", cascade={"persist"})
	 * 
     ...
     *
     * @param MyApp\MobileBundle\Entity\Texte_complementaire_section_principale_en $texteComplementaireEn
     */
    public function setTexteComplementaireEn(\MyApp\MobileBundle\Entity\Texte_complementaire_section_principale_en $texteComplementaireEn)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Texte_complementaire_section_principale_en 
     */
