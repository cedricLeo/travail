...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\LitsRepository")
 * @ORM\Table(name = "lits")
 */
class Lits{
     ...
     * Add chambrelit_id
     *
     * @param MyApp\MobileBundle\Entity\Chambres $chambrelitId
     */
    public function addChambres(\MyApp\MobileBundle\Entity\Chambres $chambrelitId)
    {
