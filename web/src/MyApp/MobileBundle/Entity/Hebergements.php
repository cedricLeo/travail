 ...
 * @ORM\Table(name = "hebergements", indexes={@ORM\index(name="hebergement_idx", columns={"id", "province_id", "region_id", "ville_id", "zone_id", "nom_fr"})})
...
class Hebergements{
	...
	/**
	 * @ORM\ManyToOne(targetEntity="MyApp\MobileBundle\Entity\Politique_en", cascade={"persist"})
	 */
	private $politique_hebergement_en;
	
	/**
	 * @ORM\ManyToOne(targetEntity="MyApp\MobileBundle\Entity\Description_fr", cascade={"persist"})
	 */
	private $description_hebergement_fr;
	
	/**
	 * @ORM\ManyToOne(targetEntity="MyApp\MobileBundle\Entity\Description_en", cascade={"persist"})
	 */
     ...
     */
    public function addForfaits(\MyApp\MobileBundle\Entity\Forfaits $forfaitId)
    {
     ...
     * Add affiliation_id
     *
     * @param MyApp\MobileBundle\Entity\Affiliations $affiliationId
     */
    public function addAffiliations(\MyApp\MobileBundle\Entity\Affiliations $affiliationId)
    {
     ...
     * Set qcs_forfait_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_forfaits $qcsForfaitId
     */
    public function setQcsForfaitId(\MyApp\MobileBundle\Entity\Qcs_forfaits $qcsForfaitId)
    {
     ...
     * Get qcs_forfait_id
     *
     * @return MyApp\MobileBundle\Entity\Qcs_forfaits 
     */
     ...
     */
    public function setQcsEchoHebergementId(\MyApp\MobileBundle\Entity\Qcs_echos_hebergements $qcsEchoHebergementId)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Qcs_echos_hebergements 
     */
     ...
     */
    public function setQcsConcourId(\MyApp\MobileBundle\Entity\Qcs_concours $qcsConcourId)
    {
     ...
     * Get qcs_concour_id
     *
     * @return MyApp\MobileBundle\Entity\Qcs_concours 
     */
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements_services $hebergementServiceId
     */
    public function addHebergements_services(\MyApp\MobileBundle\Entity\Hebergements_services $hebergementServiceId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Styles_hebergements $styleHebergementId
     */
    public function addStyles_hebergements(\MyApp\MobileBundle\Entity\Styles_hebergements $styleHebergementId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Qcs_thematiques_hebergements $qcsThematiquesHebergementId
     */
    public function setQcsThematiquesHebergementId(\MyApp\MobileBundle\Entity\Qcs_thematiques_hebergements $qcsThematiquesHebergementId)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Qcs_thematiques_hebergements 
     */
     ...
     * Add video_id
     *
     * @param MyApp\MobileBundle\Entity\Videos $videoId
     */
    public function addVideos(\MyApp\MobileBundle\Entity\Videos $videoId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Equipements $hebergementEquipementId
     */
    public function addEquipements(\MyApp\MobileBundle\Entity\Equipements $hebergementEquipementId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Modes_paiements $hebergementPaiementsId
     */
    public function addModes_paiements(\MyApp\MobileBundle\Entity\Modes_paiements $hebergementPaiementsId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements_activites $hebergementActiviteId
     */
    public function addHebergements_activites(\MyApp\MobileBundle\Entity\Hebergements_activites $hebergementActiviteId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Forfaits_clients $hebergementForfaitClientId
     */
    public function addForfaits_clients(\MyApp\MobileBundle\Entity\Forfaits_clients $hebergementForfaitClientId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Galerie_hebergement $galerieHebergement
     */
    public function addGalerie_hebergement(\MyApp\MobileBundle\Entity\Galerie_hebergement $galerieHebergement)
    {
     ...
     * Add distance_id
     *
     * @param MyApp\MobileBundle\Entity\Distances $distanceId
     */
    public function addDistances(\MyApp\MobileBundle\Entity\Distances $distanceId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Temporaire_attraits $temporaireAttraitId
     */
    public function addTemporaire_attraits(\MyApp\MobileBundle\Entity\Temporaire_attraits $temporaireAttraitId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Politique_fr $hebergementPolitiqueFr
     */
    public function setHebergementPolitiqueFr(\MyApp\MobileBundle\Entity\Politique_fr $hebergementPolitiqueFr)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Politique_fr 
     */
     ...
     *
     * @param MyApp\MobileBundle\Entity\Politique_en $hebergementPolitiqueEn
     */
    public function setHebergementPolitiqueEn(\MyApp\MobileBundle\Entity\Politique_en $hebergementPolitiqueEn)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Politique_en 
     */
     ...
     * Set acompte_id
     *
     * @param MyApp\MobileBundle\Entity\Acomptes $acompteId
     */
    public function setAcompteId(\MyApp\MobileBundle\Entity\Acomptes $acompteId)
    {
     ...
     * Get acompte_id
     *
     * @return MyApp\MobileBundle\Entity\Acomptes 
     */
     ...
     *
     * @param MyApp\MobileBundle\Entity\Classifications $classificationId
     */
    public function setClassificationId(\MyApp\MobileBundle\Entity\Classifications $classificationId)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Classifications 
     */
     ...
     *
     * @param MyApp\MobileBundle\Entity\Categories_hebergements $categorieHebergementId
     */
    public function addCategories_hebergements(\MyApp\MobileBundle\Entity\Categories_hebergements $categorieHebergementId)
    {
     ...
     * Add calendrier
     *
     * @param MyApp\MobileBundle\Entity\Calendrier_saison $calendrier
     */
    public function addCalendrier_saison(\MyApp\MobileBundle\Entity\Calendrier_saison $calendrier)
    {
     ...
     * Add salles_corpo_id
     *
     * @param MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $sallesCorpoId
     */
    public function addHebergements_salles_corporatives(\MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $sallesCorpoId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Chambres $chambreHebergementId
     */
    public function addChambres(\MyApp\MobileBundle\Entity\Chambres $chambreHebergementId)
    {
