...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Type_evenementsRepository")
...
class Types_evenements
{
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $serviceCorporatif
     */
    public function addHebergements_salles_corporatives(\MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $serviceCorporatif)
    {
     ...
     * Add appel_offre_id
     *
     * @param MyApp\MobileBundle\Entity\Appel_Offre $appelOffreId
     */
    public function addAppel_Offre(\MyApp\MobileBundle\Entity\Appel_Offre $appelOffreId)
    {
