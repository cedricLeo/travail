...
class Texte_province_attraitRepository extends EntityRepository
{
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_attrait p WHERE p.province =:id';
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_attrait p WHERE p.province =:province AND p.categorie_attrait = :attrait';
        $query = $this->getEntityManager()->createQuery($sql);
