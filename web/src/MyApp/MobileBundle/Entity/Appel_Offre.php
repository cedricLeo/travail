...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Appel_OffreRepository")
...
class Appel_Offre
{
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $salleCorporativeHebergementId
     */
    public function addHebergements_salles_corporatives(\MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $salleCorporativeHebergementId)
    {
     ...
     * Set type_event_id
     *
     * @param MyApp\MobileBundle\Entity\Types_evenements $typeEventId
     */
    public function setTypeEventId(\MyApp\MobileBundle\Entity\Types_evenements $typeEventId)
    {
     ...
     * Get type_event_id
     *
     * @return MyApp\MobileBundle\Entity\Types_evenements 
     */
     ...
     */
    public function addProvinces_etats(\MyApp\MobileBundle\Entity\Provinces_etats $provinceId)
    {
