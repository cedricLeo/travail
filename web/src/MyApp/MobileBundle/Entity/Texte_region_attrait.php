...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_region_attraitRepository")
 * @ORM\Table(name = "texte_region_attrait")
 */
class Texte_region_attrait {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_attrait")
     * 
     * @var integer $region
     */
    private $region;
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Attraits_categories", inversedBy = "Texte_region_attrait")
     * 
     ...
     */
    public function setCategorieAttrait(\MyApp\MobileBundle\Entity\Attraits_categories $categorieAttrait)
    {
