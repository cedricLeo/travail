...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_region_restaurantRepository")
 * @ORM\Table(name = "texte_region_restaurant")
 */
class Texte_region_restaurant {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_restaurant")
     * 
     * @var integer $region
     */
    private $region;
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Cuisines", inversedBy = "Texte_region_restaurant")
     * 
     * @var integer $cuisine
     */
    private $cuisine;
