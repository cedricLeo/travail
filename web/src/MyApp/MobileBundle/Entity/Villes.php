...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\VillesRepository")
...
class Villes{
     ...
     */
    public function addUtilisateur(\MyApp\MobileBundle\Entity\Utilisateur $utilisateur)
    {
     ...
     * Add video
     *
     * @param MyApp\MobileBundle\Entity\Videos $video
     */
    public function addVideos(\MyApp\MobileBundle\Entity\Videos $video)
    {
        $this->video[] = $video;
    }
