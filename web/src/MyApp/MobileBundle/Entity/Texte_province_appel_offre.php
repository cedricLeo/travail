...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_appel_offreRepository")
 * @ORM\Table(name = "texte_province_appel_offre")
 */
class Texte_province_appel_offre {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_appel_offre")
     * 
