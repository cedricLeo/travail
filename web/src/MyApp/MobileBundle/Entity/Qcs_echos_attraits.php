...
class Qcs_echos_attraits{
	...
	/**
	 * @ORM\ManyToMany(targetEntity="Attraits", inversedBy="Qcs_echos_attraits")
	 * 
     ...
     *
     * @param MyApp\MobileBundle\Entity\Qcs_types_saisons $qcsTypeSaisonId
     */
    public function setQcsTypeSaisonId(\MyApp\MobileBundle\Entity\Qcs_types_saisons $qcsTypeSaisonId)
    {
