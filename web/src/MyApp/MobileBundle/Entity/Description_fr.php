...
class Description_fr{
    ...
    /**
     * @ORM\OneToMany(targetEntity="MyApp\MobileBundle\Entity\Hebergements", mappedBy="Description_fr")
     */
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements $hebergementDescriptionFr
     */
    public function addHebergements(\MyApp\MobileBundle\Entity\Hebergements $hebergementDescriptionFr)
    {
