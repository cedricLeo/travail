...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Forfaits_clientsRepository")
...
class Forfaits_clients{
	...
	*/
     ...
     *
     * @param MyApp\MobileBundle\Entity\Forfaits $forfaitClientId
     */
    public function setForfaitClientId(\MyApp\MobileBundle\Entity\Forfaits $forfaitClientId)
    {
     ...
     * Set corpo_id
     *
     * @param MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $corpoId
     */
    public function setCorpoId(\MyApp\MobileBundle\Entity\Hebergements_salles_corporatives $corpoId)
    {
     ...
     * Get corpo_id
     *
     * @return MyApp\MobileBundle\Entity\Hebergements_salles_corporatives 
     */
     ...
     */
    public function setAttraitId(\MyApp\MobileBundle\Entity\Attraits $attraitId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Galerie_forfaits $galerieForfaits
     */
    public function addGalerieForfaits(\MyApp\MobileBundle\Entity\Galerie_forfaits $galerieForfaits)
    {
     ...
     * @param MyApp\MobileBundle\Entity\Galerie_forfaits $galerieForfaits
     */
    public function addGalerie_forfaits(\MyApp\MobileBundle\Entity\Galerie_forfaits $galerieForfaits)
    {
        $this->galerie_forfaits[] = $galerieForfaits;
    }
