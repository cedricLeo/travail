...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_chambre_affaireRepository")
 * @ORM\Table(name = "texte_province_chambre_affaire")
 */
class Texte_province_chambre_affaire {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_chambre_affaire")
     * 
