...
class Texte_region_forfaitRepository extends EntityRepository
{
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_region_forfait p WHERE p.region =:id';
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_region_forfait p WHERE p.region =:region AND p.forfait =:forfait';
        $query = $this->getEntityManager()->createQuery($sql);
