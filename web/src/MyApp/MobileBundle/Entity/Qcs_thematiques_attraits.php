...
/**
 * @ORM\Entity
 * @ORM\Table(name = "qcs_thematiques_attraits")
 */
class Qcs_thematiques_attraits{
	...
	/**
	 * @ORM\ManyToMany(targetEntity = "Qcs_thematiques", mappedBy = "Qcs_thematiques_attraits")
	 * 
     ...
     */
    public function setQcsThematiqueId(\MyApp\MobileBundle\Entity\Qcs_thematiques $qcsThematiqueId)
    {
     ...
     *
     * @return MyApp\MobileBundle\Entity\Qcs_thematiques 
     */
     ...
     * Set attrait_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_thematiques $attraitId
     */
    public function setAttraitId(\MyApp\MobileBundle\Entity\Qcs_thematiques $attraitId)
    {
     ...
     * @param MyApp\MobileBundle\Entity\Qcs_thematiques $attraitId
     */
    public function addQcs_thematiques(\MyApp\MobileBundle\Entity\Qcs_thematiques $attraitId)
    {
        $this->attrait_id[] = $attraitId;
    }
