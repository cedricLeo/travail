...
/**
 * MyApp\MobileBundle\Entity\Utilisateur
 * @ORM\Table(name="utilisateur", indexes={@ORM\index(name="utilisateur_idx", columns={"username"})})
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\UtilisateurRepository")
 * 
 */
class Utilisateur implements UserInterface 
{
     ...
     * Set villes
     *
     * @param MyApp\MobileBundle\Entity\Villes $villes
     */
    public function setVilles(\MyApp\MobileBundle\Entity\Villes $villes)
    {
        $this->villes = $villes;
    }
     ...
     * Add hebergements
     *
     * @param MyApp\MobileBundle\Entity\Hebergements $hebergements
     */
    public function addHebergements(\MyApp\MobileBundle\Entity\Hebergements $hebergements)
    {
     ...
     * Add attraits
     *
     * @param MyApp\MobileBundle\Entity\Attraits $attraits
     */
    public function addAttraits(\MyApp\MobileBundle\Entity\Attraits $attraits)
    {
