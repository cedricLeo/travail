...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Hebergements_activitesRepository")
...
class Hebergements_activites{
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements $activiteHebergement
     */
    public function addHebergements(\MyApp\MobileBundle\Entity\Hebergements $activiteHebergement)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Distances $distanceHebergementActivite
     */
    public function addDistances(\MyApp\MobileBundle\Entity\Distances $distanceHebergementActivite)
    {
