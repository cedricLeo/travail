...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Cuisines_Repository")
...
class Cuisines{
   ...
   private $texte_province_sante;
     ...
     *
     * @param MyApp\MobileBundle\Entity\Texte_region_restaurant $texteRegionSante
     */
    public function addTexte_region_restaurant(\MyApp\MobileBundle\Entity\Texte_region_restaurant $texteRegionSante)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Texte_province_restaurant $texteProvinceSante
     */
    public function addTexte_province_restaurant(\MyApp\MobileBundle\Entity\Texte_province_restaurant $texteProvinceSante)
    {
