...
class Qcs_reglements
{
	...
	*/
     ...
     * Set concour_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_concours $concourId
     */
    public function setConcourId(\MyApp\MobileBundle\Entity\Qcs_concours $concourId)
    {
     ...
     * @param MyApp\MobileBundle\Entity\Qcs_concours $concourId
     */
    public function addQcs_concours(\MyApp\MobileBundle\Entity\Qcs_concours $concourId)
    {
        $this->concour_id[] = $concourId;
    }
}