...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\ForfaitRepository")
 ...
 *
     ...
     * Add qcs_forfaits_id
     *
     * @param MyApp\MobileBundle\Entity\Qcs_forfaits $qcsForfaitsId
     */
    public function addQcs_forfaits(\MyApp\MobileBundle\Entity\Qcs_forfaits $qcsForfaitsId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements $hebergementForfait
     */
    public function addHebergements(\MyApp\MobileBundle\Entity\Hebergements $hebergementForfait)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Texte_region_forfait $texteRegionForfaitId
     */
    public function addTexte_region_forfait(\MyApp\MobileBundle\Entity\Texte_region_forfait $texteRegionForfaitId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Texte_province_forfait $texteProvinceForfaitId
     */
    public function addTexte_province_forfait(\MyApp\MobileBundle\Entity\Texte_province_forfait $texteProvinceForfaitId)
    {
