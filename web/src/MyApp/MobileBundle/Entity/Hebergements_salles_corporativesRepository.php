...
class Hebergements_salles_corporativesRepository extends EntityRepository{
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p WHERE p.salle_corporative_hebergement = :id';
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p WHERE p.salle_corporative_hebergement = :id AND p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p WHERE p.salle_corporative_hebergement IN (:id) GROUP BY p.salle_corporative_hebergement';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p WHERE p.actif = 1';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p WHERE p.id = :id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p, b, q FROM MyAppMobileBundle:Hebergements_salles_corporatives p JOIN p.type_evenement b JOIN p.corporatif_service_id q JOIN p.salle_corporative_hebergement w WHERE p.salle_corporative_hebergement = :id AND p.actif = 1 AND w.corporatif = 1 GROUP BY b.nom_fr, q.nom_fr';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p '.
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p WHERE p.actif = 1 GROUP BY p.salle_corporative_hebergement';
		$query = $this->getEntityManager()->createQuery($sql);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p JOIN p.salle_corporative_hebergement q WHERE  q.corporatif = 1 AND q.province_id = :id AND p.actif = 1 GROUP BY q.region_id';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('id', $id);
		return $query->getResult();
	}
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p JOIN p.salle_corporative_hebergement q WHERE q.id IN (:tab) AND q.corporatif = 1 AND p.actif = 1 GROUP BY p.salle_corporative_hebergement';
		$query = $this->getEntityManager()->createQuery($sql);
	...
	{
		$sql = 'SELECT p FROM MyAppMobileBundle:Hebergements_salles_corporatives p JOIN p.salle_corporative_hebergement q WHERE q.region_id = :tab AND q.corporatif = 1 AND p.actif = 1 GROUP BY p.salle_corporative_hebergement';
		$query = $this->getEntityManager()->createQuery($sql);
		$query->setParameter('tab', $tab);
