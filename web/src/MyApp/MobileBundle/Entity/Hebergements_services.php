...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Hebergements_servicesRepository")
...
class Hebergements_services{
     ...
     *
     * @param MyApp\MobileBundle\Entity\Hebergements $hebergementService
     */
    public function addHebergements(\MyApp\MobileBundle\Entity\Hebergements $hebergementService)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Distances $distanceHebergementService
     */
    public function addDistances(\MyApp\MobileBundle\Entity\Distances $distanceHebergementService)
    {
