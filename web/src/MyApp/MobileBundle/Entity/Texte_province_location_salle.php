...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_location_salleRepository")
 * @ORM\Table(name = "texte_province_location_salle")
 */
class Texte_province_location_salle {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_location_salle")
     * 
