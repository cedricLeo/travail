...
class Qcs_echos_hebergements
{
	...
	/**
	 * @ORM\OneToOne(targetEntity = "Hebergements", mappedBy = "Qcs_echos_hebergements")
	 * 
	...
	/**
	 * @ORM\ManyToOne(targetEntity = "Qcs_types_saisons", inversedBy = "Qcs_echos_hebergements")
	 *
	...
	*/
    ...
    {
        $this->qcs_saison = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * Add qcs_saison
     *
     * @param MyApp\MobileBundle\Entity\Qcs_saisons $qcsSaison
     */
    public function addQcs_saisons(\MyApp\MobileBundle\Entity\Qcs_saisons $qcsSaison)
    {
