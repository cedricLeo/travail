...
class Texte_province_categorieRepository extends EntityRepository
{
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_categorie p WHERE p.province =:id';
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_categorie p WHERE p.province =:province AND p.categorie_hebergement =:cat';
        $query = $this->getEntityManager()->createQuery($sql);
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_categorie p WHERE p.province =:province AND p.categorie_hebergement IN (:cat)';
        $query = $this->getEntityManager()->createQuery($sql);
        $query->setParameter("province", $province);
        $query->setParameter("cat", $cat);
        return $query->getResult();
