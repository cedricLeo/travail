...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Attraits_activitesRepository")
...
class Attraits_activites{
     ...
     *
     * @param MyApp\MobileBundle\Entity\Attraits $attraitActiviteId
     */
    public function addAttraits(\MyApp\MobileBundle\Entity\Attraits $attraitActiviteId)
    {
     ...
     *
     * @param MyApp\MobileBundle\Entity\Distances $distanceAttraitActivite
     */
    public function addDistances(\MyApp\MobileBundle\Entity\Distances $distanceAttraitActivite)
    {
