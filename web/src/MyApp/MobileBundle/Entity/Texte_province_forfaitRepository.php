...
class Texte_province_forfaitRepository extends EntityRepository
{
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_forfait p WHERE p.province =:id';
    ...
    {
        $sql = 'SELECT p FROM MyAppMobileBundle:Texte_province_forfait p WHERE p.province = :province AND p.forfait =:forfait';
        $query = $this->getEntityManager()->createQuery($sql);
