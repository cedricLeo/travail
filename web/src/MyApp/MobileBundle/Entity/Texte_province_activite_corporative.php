...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_province_activite_corporativeRepository")
 * @ORM\Table(name = "texte_province_activite_corporative")
 */
class Texte_province_activite_corporative {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Provinces_etats", inversedBy = "Texte_province_activite_corporative")
     * 
