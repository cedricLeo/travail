...
/**
 * @ORM\Entity(repositoryClass="MyApp\MobileBundle\Entity\Texte_region_chambre_affaireRepository")
 * @ORM\Table(name = "texte_region_chambre_affaire")
 */
class Texte_region_chambre_affaire {
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "Regions", inversedBy = "Texte_region_chambre_affaire")
     * 
     * @var integer $region
     */
    private $region;
