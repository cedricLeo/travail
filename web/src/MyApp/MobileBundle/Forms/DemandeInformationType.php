<?php
namespace MyApp\MobileBundle\Forms;
 ...
 *
 */
class DemandeInformationType extends AbstractType
{	
	public function buildForm(FormBuilder $builder, array $options)
	{
		$builder
			...
			->add('vos_dates_flexibles', 'choice', array('choices' => array('nb' => 'N/D', 'oui' => 'Oui', 'non' => 'Non')))		
			->add('disposition_salle', 'choice', array('choices' => array('banquet' => 'Banquet', 'carre_ouvert' => 'Carré ouvert', 'chevrons' => 'Chevrons', 'conference' => 'Conférence', 'demi_lune' => 'Demi lune', 'ecole' => 'École', 'ent' => 'En T', 'enu' => 'En U', 'salon_commercial' => 'Salon commercial', 'theatre' => 'Théatre', 'autres' => 'Autres')))
