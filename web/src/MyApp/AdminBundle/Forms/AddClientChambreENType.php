 ...
 * @author leonardc
 * 
 * Formulaire pour l'ajout et modification des chambres compte client version en
 *
 */
class AddClientChambreENType extends AbstractType
{
	public function buildForm(FormBuilder $builder, array $options)
	{
		...
		->add('lit_id', 'entity', array('class'		 	=> 'MyAppGlobalBundle:Lits',
										...
										'multiple' 		=> true,
										'query_builder' => function(EntityRepository $er){
										return $er->createQueryBuilder('l')->orderBy('l.nom_en', 'ASC');
										}))
		//Relation avec le type de lit
		->add('equipement_id', 'entity', array( 'class'		 	=> 'MyAppGlobalBundle:Equipements',
												...
												'multiple' 		=> true,
												'query_builder' => function(EntityRepository $er){
												return $er->createQueryBuilder('e')->orderBy('e.nom_en', 'ASC');
												}))
