...
class DeviseFicheClientEnHebergementType extends AbstractType
{
	public function buildForm(FormBuilder $builder, array $options)
	{
		$builder
		->add('devise_id', 'entity', array('class' => 'MyAppGlobalBundle:Devises', 'property' => 'abreviation','required' => true, "multiple" => true))
		->add('hebergement_paiements_id', 'entity', array('class' => 'MyAppGlobalBundle:Modes_paiements', 'property' => 'nomen' , 'required' => true, "multiple" => true))
		;
	}
